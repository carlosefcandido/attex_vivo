...
<table width="969" border="0">
  <tr>
    ...
    <td width="41">CPF</td>
    <td width="263"><input type="text" name="cpf" value="" maxlength="14" OnKeyPress="formatar('###.###.###-##', this)" /></td>
    <td width="75">Nome da Mãe</td>
    <td width="259"><input type="text" name="nome_mae" value='' /></td>
  </tr>
</table>
<table width="969" border="0">
  <tr>
    <td width="56">Tel. de Contato</td>
    <td width="251"><input type="text" name="telefone_contato" value=""  maxlength="12" OnKeyPress="formatar('##-####-####', this)"/></td>
    <td width="40">E-mail</td>
    <td width="604"><input type="text" name="email" value="" /></td>
    </tr>
 </table>
 <table width="973">
    <tr>
    <td width="24">Rua</td>
    <td width="282"><input type="text" name="rua" value="" /></td>
    <td width="36">Bairro</td>
    <td width="268"><input type="text" name="bairro" value="" /></td>
    <td width="81">Cidade</td>
    <td width="254"><input type="text" name="cidade" value="" /></td>
  </tr>
</table>
   <br> 
  <table width="981" border="0">
    <tr>
    <td width="24">Fixo</td>
    <td width="267"><select name="produto1">
    		<option value=""></option>
    		<option value="R$ 21,20">R$ 21,20</option>
            <option value="R$ 29,90">R$ 29,90</option>
            <option value="R$ 59,90">R$ 59,90</option>
            </select></td>
    <td width="63">Controle</td>
    <td width="271"><select name="produto2">
    		<option value=""></option>
            
    		<option value="R$ 31,90">R$ 31,90</option>
            <option value="R$ 41,90">R$ 41,90</option>
            <option value="R$ 51,90">R$ 51,90</option>
            </select></td>
    <td width="62">Modem</td>        
    <td width="268"><select name="produto3">
    		<option value=""></option>
            ...
            <option value="20GB R$ 159,90">20GB R$ 159,90</option>
            </select>
            </td>        
  </tr>
  </table>
