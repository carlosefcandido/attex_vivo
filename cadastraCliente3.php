	 ...
	 if(isset($_POST['acao']) && $_POST['acao'] == "cadastrar_cliente"){
	 	if($cpf == ""){
	 		echo "<script>alert('Os campos não podem ficar vazios'); location.href='cadastrar-cliente-vendedor.php'</script>";
					...
					$inserirClientes = mysql_query("INSERT INTO clientes (data_venda, cliente, cpf, nome_mae, telefone_contato, email, produto1, produto2, produto3, rua, bairro, cidade, status_atual, id_usuario) VALUES ('$data_venda', '$cliente', '$cpf', '$nome_mae', '$telefone_contato', '$email', '$produto1', '$produto2', '$produto3', '$rua', '$bairro', '$cidade', 'Pendente', '$id_usuario')");
