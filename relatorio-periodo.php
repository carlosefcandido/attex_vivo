...
while ($oRow = mysql_fetch_array($oResult)) {
	...
	echo "<table border='1' width='1400' align='center'>
	<tr>
        <td>
        	Total de Clientes
        </td>
